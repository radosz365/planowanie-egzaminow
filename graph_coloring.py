...
for i, row1 in df.iterrows():
    for j, row2 in df.iterrows():
        if i < j:
            if (row1['lecturer'] == row2['lecturer'] or
                row1['group'] == row2['group'] or
                row1['classroom'] == row2['classroom']):
                G.add_edge(i, j)

coloring = nx.coloring.greedy_color(G, strategy='largest_first')

start_date = datetime(2025, 1, 30)
time_slots_per_day = ['8:00 - 8:45', '9:00 - 9:45', '10:00 - 10:45', '11:00 - 11:45', 
                       '12:00 - 12:45', '13:00 - 13:45', '14:00 - 14:45', '15:00 - 15:45', '16:00 - 16:45']
slot_index = 0
